...
DO $$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20201120171903_TypeDefinitions') THEN
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20201120171903_TypeDefinitions') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20201120171903_TypeDefinitions', '5.0.0');
    END IF;
END $$;
COMMIT;
...
DO $$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20201201185420_VariableByteContent') THEN
    ALTER TABLE "Variables" ADD "Bytes" bytea NULL;
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20201201185420_VariableByteContent') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20201201185420_VariableByteContent', '5.0.0');
    END IF;
END $$;
COMMIT;
