...
BEGIN
    ...
    VALUES (N'20201026154514_Initial', N'5.0.0');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20201119154554_ClaimsIssuer')
BEGIN
    ALTER TABLE [UserClaims] ADD [Issuer] nvarchar(max) NULL;
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20201119154554_ClaimsIssuer', N'5.0.0');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20201119175737_AuthenticationProviders')
BEGIN
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20201119175737_AuthenticationProviders', N'5.0.0');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20201119190656_AuthenticationProvidersEnable')
BEGIN
    ALTER TABLE [AuthenticationProviders] ADD [Enabled] bit NOT NULL DEFAULT CAST(0 AS bit);
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20201119190656_AuthenticationProvidersEnable', N'5.0.0');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20201119202658_AuthenticationProvidersType')
BEGIN
    DECLARE @var0 sysname;
    SELECT @var0 = [d].[name]
    FROM [sys].[default_constraints] [d]
    INNER JOIN [sys].[columns] [c] ON [d].[parent_column_id] = [c].[column_id] AND [d].[parent_object_id] = [c].[object_id]
    WHERE ([d].[parent_object_id] = OBJECT_ID(N'[AuthenticationProviders]') AND [c].[name] = N'Type');
    IF @var0 IS NOT NULL EXEC(N'ALTER TABLE [AuthenticationProviders] DROP CONSTRAINT [' + @var0 + '];');
    ALTER TABLE [AuthenticationProviders] ALTER COLUMN [Type] nvarchar(max) NULL;
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20201119202658_AuthenticationProvidersType', N'5.0.0');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20201120074140_UserExternalClaims')
BEGIN
    DECLARE @var1 sysname;
    SELECT @var1 = [d].[name]
    FROM [sys].[default_constraints] [d]
    INNER JOIN [sys].[columns] [c] ON [d].[parent_column_id] = [c].[column_id] AND [d].[parent_object_id] = [c].[object_id]
    WHERE ([d].[parent_object_id] = OBJECT_ID(N'[UserClaims]') AND [c].[name] = N'Issuer');
    IF @var1 IS NOT NULL EXEC(N'ALTER TABLE [UserClaims] DROP CONSTRAINT [' + @var1 + '];');
    ALTER TABLE [UserClaims] DROP COLUMN [Issuer];
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20201120074140_UserExternalClaims', N'5.0.0');
END;
GO
