...
CREATE TABLE "ef_temp_AuthenticationProviders" (
    "Id" TEXT NOT NULL CONSTRAINT "PK_AuthenticationProviders" PRIMARY KEY,
    "Description" TEXT NULL,
    "DisplayName" TEXT NULL,
    "Enabled" INTEGER NOT NULL,
...
INSERT INTO "ef_temp_AuthenticationProviders" ("Id", "Description", "DisplayName", "Enabled", "Name", "Parameters", "Type")
SELECT "Id", "Description", "DisplayName", "Enabled", "Name", "Parameters", "Type"
...
DROP TABLE "AuthenticationProviders";

ALTER TABLE "ef_temp_AuthenticationProviders" RENAME TO "AuthenticationProviders";
...
INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20201119202646_AuthenticationProvidersType', '5.0.0');
...
CREATE TABLE "ef_temp_UserClaims" (
    "Id" TEXT NOT NULL CONSTRAINT "PK_UserClaims" PRIMARY KEY,
    "ConcurrencyStamp" TEXT NULL,
    "Type" TEXT NOT NULL,
    "UserId" TEXT NOT NULL,
...
INSERT INTO "ef_temp_UserClaims" ("Id", "ConcurrencyStamp", "Type", "UserId", "Value")
SELECT "Id", "ConcurrencyStamp", "Type", "UserId", "Value"
FROM UserClaims;
...
ALTER TABLE "ef_temp_UserClaims" RENAME TO "UserClaims";
...
INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20201120074129_UserExternalClaims', '5.0.0');
