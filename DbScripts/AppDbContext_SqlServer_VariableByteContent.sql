...
BEGIN
    ...
    VALUES (N'20201026154457_Initial', N'5.0.0');
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20201108190552_AddPermissions', N'5.0.0');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20201112184542_PermissionRuleOrder')
BEGIN
    ALTER TABLE [EndpointRulePermission] ADD [Order] decimal(18,2) NOT NULL DEFAULT 0.0;
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20201112184542_PermissionRuleOrder', N'5.0.0');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20201120171909_TypeDefinitions')
BEGIN
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20201120171909_TypeDefinitions', N'5.0.0');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20201201185425_VariableByteContent')
BEGIN
    ALTER TABLE [Variables] ADD [Bytes] varbinary(max) NULL;
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20201201185425_VariableByteContent', N'5.0.0');
END;
GO
