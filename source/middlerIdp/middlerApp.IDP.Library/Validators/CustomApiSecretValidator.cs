...
namespace middlerApp.IDP.Library.Validators
{
    ...
    public class CustomApiSecretValidator : IApiSecretValidator
    {
        ...
        public CustomApiSecretValidator(IResourceStore resources, ISecretsListParser parsers, ISecretsListValidator validator, IEventService events, ILogger<ApiSecretValidator> logger)
        {
