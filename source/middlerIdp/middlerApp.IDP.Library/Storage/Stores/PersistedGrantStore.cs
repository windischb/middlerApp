...
using middlerApp.IDP.Library.Mappers;

namespace middlerApp.IDP.Library.Storage.Stores
{
    /// <summary>
    ...
    public class PersistedGrantStore : IPersistedGrantStore
    {
        ...
        {
            var persistedGrant = await Context.PersistedGrants.AsQueryable().FirstOrDefaultAsync(x => x.Key == key);
        ...
        private IQueryable<DataAccess.Entities.Entities.PersistedGrant> Filter(PersistedGrantFilter filter)
        {
