...
import { IdentityUIConfig, IdentityUIConfigService } from '../../../identity-ui-config.service';
...
export class AuthenticationService {
    ...
    private identityUIConfig: IdentityUIConfig;
    constructor(private oauthService: OAuthService, private identityUIConfigService: IdentityUIConfigService) {

        this.identityUIConfig = identityUIConfigService.getConfiguration();

        this.authConfig = {

            issuer: this.identityUIConfig.IDPBaseUri,
