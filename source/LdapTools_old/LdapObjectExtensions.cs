...
namespace LdapTools
{
    public static class LdapObjectExtensions
    {
        ...
        {
            return dict.Properties.TryGetValue(key, out var value) ? value : null;
        }

        public static string GetStringValue(this LdapObject dict, string key)
        {
            return dict.Properties.TryGetValue(key, out var value) ? value as string : null;
        }
        ...
        public static bool GetBooleaValue(this LdapObject dict, string key)
        {
            var val = dict.Properties.TryGetValue(key, out var value) ? value as string : null;
